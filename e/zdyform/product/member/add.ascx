...
<input type='hidden' name='mustname' value='产品名称,产品图组,标题图片,发布日期,'><input type='hidden' name='mustfield' value='title,pa_images,titlepic,thedate,'><input type='hidden' name='musttype' value='text,images,image,text,'>
